...
public abstract class Settings {
    ...
    public static double RANGE_LIFE_LENGTH_FROM = 250.0;
    public static double RANGE_LIFE_LENGTH_TO = 1300.0;
    public static double RANGE_PATIENCE_FROM = 5.0;
    public static double RANGE_PATIENCE_TO = 20.0;
    ...
    public static double RANGE_TALENT_FROM = 1.0;
    public static double RANGE_TALENT_TO = 20.0;
    public static int VALUE_CHILD_EXPENSE = 10;
    public static int SIZE_ENTITY_SET = 100;
    ...
    public static double C_SOURCES_POOL = 10; // C - priblizny pocet vlaken
